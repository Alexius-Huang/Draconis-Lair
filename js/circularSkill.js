  ...
  setTimeout(function() {
    ...
    var skillDetails = {
      'HTML5 & CSS3': {
        ...
        xPos: 20,
        child: {
          'Bootstrap':     { percentage: 95, x: 10 },
          'Sass':          { percentage: 80, x: 40 },
          'Canvas':        { percentage: 65, x: 30 },
          'RWD':           { percentage: 60, x: 40 }
        }
      },
      'JavaScript': {
        percentage: 85,
        xPos: 60,
        child: {
          'jQuery':        { percentage: 95, x: 30 },
          'ES6':           { percentage: 80, x: 40 },
          'ReactJS':       { percentage: 85, x: 25 },
        }
      },
      'PHP': {
        percentage: 90,
        xPos: 100,
        child: {
          'CodeIgniter 3': { percentage: 90, x: 1 },
          'PHPExcel':      { percentage: 65, x: 20 },
        }
      },
      'Ruby': {
        percentage: 85,
        xPos: 95,
        child: {
          'Ruby on Rails': { percentage: 70, x: 1 },
        }
      },
      'Python': {
        percentage: 55,
